...
public interface UserDao {
    ...
    @Update("UPDATE user SET name=#{user.name}, phone=#{user.phone},introduction=#{user.introduction}, organization=#{user.organization},attr=#{user.attr},pictureUrl=#{user.pictureUrl} WHERE id=#{user.id};")
